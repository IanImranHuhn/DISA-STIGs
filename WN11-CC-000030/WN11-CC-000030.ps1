...
.NOTES
    ...
    STIGaview Link  : https://stigaview.com/products/win11/v2r5/WN11-CC-000030/
...
if ($null -eq $CurrentValue) {
    Write-Host "$ValueName is missing. Setting to $DesiredValue (ICMP Redirects Disabled)." -ForegroundColor Red
    ...
    Write-Host "ICMP Redirects are already correctly disabled ($ValueName = $DesiredValue)." -ForegroundColor Green
}
