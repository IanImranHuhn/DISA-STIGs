...
.NOTES
    ...
    STIGaview Link  : https://stigaview.com/products/win11/v2r5/WN11-CC-000025/
...
if ($null -eq $CurrentValue) {
    ...
    Write-Host "IPv4 Source Routing is already correctly configured ($ValueName = $DesiredValue)." -ForegroundColor Green
}
